    ...
    <body>        
        <div class="row" style="padding-top: 20px">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" style="padding-top: 10px">
                <div class="container">
                    <a href="/Tarea2/PaginaISServlet" class="btn btn-default" style="margin-left: 50px">Iniciar Sesion</a>
                    <a href="" class="btn btn-default" style="margin: 15px">Registrarse</a>
                </div>
            </div>
