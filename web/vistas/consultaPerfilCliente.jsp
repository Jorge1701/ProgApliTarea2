                                        ...
                                        <table class="table table-user-information">
                                            ...
                                            <tbody>     
                                                ...
                                                <tr>                                                    
                                                    ...
                                                    <td><span class="badge"> <%= dtLP.getTemas().size()%> </span></td>
                                                    <% if (dtLP.isPrivada()) {%>
                                                    <td id="privada"><form method="POST" action="/Tarea2/SContenido"><div class="glyphicon glyphicon-remove-sign" style="color: red"></div><input name="nomLista" hidden value="<%= dtLP.getNombre()%>"><input name="accion" hidden value="publicarLista"><button type="submit" id="btnPublicar" class="btn btn-info" style="margin-left: 50px" >Publicar</button></form></td>
                                                            <% } else {%>
                                                    <td><div class="glyphicon glyphicon-ok-sign" style="color:green"></div></td>
                                                        <%}%>
                                                </tr>
