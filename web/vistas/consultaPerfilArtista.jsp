        ...
        <body style="background-image: url('media/wallpaper2.jpg')">
                ...
                <div class="container-fluid" >
                    ...
                    <div class="row">
                        ...
                        <!-- Contenido -->
                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 boxContenedor" style="height: 450px">
                                        ...
                                        <div class="row">
                                            <div class=""> 
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <a href="/Tarea2/SContenido?accion=AltaAlbum" class="btn btn-default" id="btnCrearAlbum" style="margin: 20px; border-color: black ">Crear Album</a>
                                                </div>
